...
<head>
    <meta charset="utf-8">
    <title>LAIC - Staff Portal</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0, user-scalable=no">
    <meta content="Minimal Admin & Dashboard Template" name="description">
    <meta content="LAIC Kh" name="author">
                ...
                <a href="{{ route('home') }}" class="group-data-[sidebar=dark]:hidden group-data-[sidebar=brand]:hidden group-data-[sidebar=modern]:hidden">
                    ...
                    <span class="group-data-[sidebar-size=sm]:hidden">
                        <!-- <img src="{{ URL::to('assets/images/logo-dark.png') }}" alt="" class="h-6 mx-auto"> -->
                         <img src="https://lifeacademy.edu.ph/wp-content/uploads/2024/08/Logo-V2-512-x-512-01.png" alt="Description of Image" style="width: 60px; height: 60px; margin-right: 0px;">
                    </span>
                </a>
